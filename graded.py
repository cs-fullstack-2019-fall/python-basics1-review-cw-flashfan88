...
userInput = input("Text Goes Here")
while userInput != 'q':
    userInput = input("Text Goes Here")
    print(userInput)
...
userInput = input("Enter the number 1 , 2, or 3")
while userInput != 'q':
    userInput = int(input("Enter the number 1, 2, or 3")) # you can't compare a string to an integer
    if userInput == 1:
        print(userInput)
    elif userInput == 2:
        print(userInput)
